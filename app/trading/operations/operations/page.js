                        ...
                        <div className={styles.cardInfo}>
                            ...
                            {op.imageUrl && (
                                <a href={op.imageUrl} target="_blank" rel="noopener noreferrer" className={styles.cardLink}>
                                    <LinkIcon size={14} /> Ver captura en TradingView
                                </a>
                            )}
                        </div>
                    ...
                    <div className={styles.modalContent}>
                        ...
                        <form className={styles.modalBody} onSubmit={handleSubmit}>
                            ...
                            <div className={styles.formGrid}>
                                ...
                                <div className={styles.formGroup}>
                                    <label>Sesión</label>
                                    <select value={formData.sesion} onChange={e => setFormData({...formData, sesion: e.target.value})}>
                                        <option value="ASIA">Asia</option>
                                        <option value="LONDRES">Londres</option>
                                        <option value="NEW YORK AM">New York AM</option>
                                        <option value="NEW YORK BM">New York BM</option>
                                        <option value="NEW YORK COMPLETA">New York Completa</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className={styles.formGrid} style={{ gridTemplateColumns: 'repeat(1, 1fr)' }}>
                                <div className={styles.formGroup}>
                                    <label>Resultado P&L ($)</label>
                                    <input type="number" step="0.01" required value={formData.pnl} onChange={e => setFormData({...formData, pnl: e.target.value})} />
                                </div>
                            </div>
                            ...
                            <div className={styles.formGroup}>
                                <label>Enlace de Captura (TradingView, etc)</label>
